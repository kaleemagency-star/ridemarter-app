...
class SmartDrivoAccessibilityService : AccessibilityService() {
    ...
    companion object {
        const val TAG = "SmartDrivoAccessService"
    ...
    override fun onServiceConnected() {
        ...
        isRunning = true
        Log.i(TAG, "SmartDrivo Accessibility Service connected successfully")
    ...
    override fun onDestroy() {
        ...
        serviceScope.cancel()
        super.onDestroy()
        Log.i(TAG, "SmartDrivo Accessibility Service destroyed")
    }
}
