...
import com.smartdrivo.app.service.SmartDrivoAccessibilityService
...
class DashboardViewModel(application: Application) : AndroidViewModel(application) {
                ...
                .addSnapshotListener { snapshot, error ->
                    ...
                    if (snapshot != null && snapshot.exists()) {
                        ...
                        val data = UserData(
                            ...
                            email = snapshot.getString("email") ?: (try { auth?.currentUser?.email } catch (e: Exception) { null } ?: "driver@smartdrivo.com"),
    ...
    fun isAccessibilityServiceEnabled(context: Context): Boolean {
        ...
        val targetService = "${context.packageName}/${SmartDrivoAccessibilityService::class.java.canonicalName}"
