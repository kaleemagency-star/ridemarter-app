...
import com.smartdrivo.app.model.DEFAULT_PLANS
import com.smartdrivo.app.model.PaymentConfig
import com.smartdrivo.app.model.PaymentRecord
            ...
            try {
                ...
                if (db != null) {
                    ...
                    if (payDoc.exists()) {
                        ...
                        val upiName = payDoc.getString("upiName") ?: "SmartDrivo Admin"
